...
To determine the best model from k-fold cross-validation, we compare the root-mean-square error of each model and take the one with the lower number. Model 1 is slightly lower than Model 2, so it is the better model.
